...
Domain analyzer extracts the behavioral and structural similarities from the applications within a domain. It expresses these similarities using the domain feature definitions of \secref{sec:features}. The computed domain features then feed into our domain-specific DSE described in \secref{sec:DSE}.
