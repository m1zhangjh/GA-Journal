...
target platform in~\secref{sec:Platform}, \newtext{and different evaluation options of domain platform, Analytic Evaluation} in~\secref{sec:Ana} and Domain Score (DS) in~\secref{sec:ds}. ~\secref{sec:eva:sum} discusses the accuracy and speed trade-off of these evaluation options.
