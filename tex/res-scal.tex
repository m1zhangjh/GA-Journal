...
\newtext{The execution time of domain-specific design space exploration contains two parts, domain analysis and design exploration. Since the domain analysis is fast and executed only once for one domain, this section only discusses the exploration time in detail. Domain analyzer has a negligible run-time due to the high level of abstraction.} Analyzing the synthetic domain with 100 apps (with up to 12 nodes each) on Intel i5-3450 with 3.10GHz takes 22.1s.
